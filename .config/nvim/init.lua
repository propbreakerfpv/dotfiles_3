...

  {
    ...
    opts = {
      ...
      sections = {
        ...
        lualine_c = { function() return vim.call('bufname') end },
  ...
  -- },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-f>", function()
        print("navigate to file 1");
        ui.nav_file(1)
      end, { desc = "navigate to file 1" })
      vim.keymap.set("n", "<C-d>", function()
        print("navigate to file 2");
        ui.nav_file(2)
      end, { desc = "navigate to file 2" })
      vim.keymap.set("n", "<C-s>", function()
        print("navigate to file 3");
        ui.nav_file(3)
      end, { desc = "navigate to file 3" })
      vim.keymap.set("n", "<C-a>", function()
        print("navigate to file 4");
        ui.nav_file(4)
...
vim.keymap.set('n', '<leader>sf', function() t_builtin.find_files({ hidden = true }) end, { desc = '[S]earch [F]iles' })
